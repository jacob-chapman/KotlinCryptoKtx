include (Modules.app, Modules.nomics, Modules.domain, Modules.newsFeature, Modules.buildSrc, Modules.common_core, Modules.common_network, Modules.common_android)
